...
const CARPETA = DriveApp.getFolderById('1Z9c9x2mJB963qBnYIWWuQUgewP1LNPR_');
...
{
    let url = 'https://randomuser.me/api/?results=5&gender=male&inc=name,email,phone,picture';
